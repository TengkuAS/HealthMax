  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          SliverAppBar(
            automaticallyImplyLeading: false, backgroundColor: themeBlue,
            expandedHeight: 200.0, toolbarHeight: 90.0, pinned: true, elevation: 0,
            ...
            title: AnimatedOpacity(
              ...
              child: Padding(
                ...
                child: ShaderMask(
                  ...
                  child: Text(themeProvider.translate('calorie_intake'), style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Colors.white, fontFamily: "LexendExaNormal")),
                ),
              ),
            ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      // --- OVERVIEW CARD ---
                      Container(
                        width: double.infinity, padding: const EdgeInsets.symmetric(vertical: 30, horizontal: 10),
                        ...
                        child: Column(
                          children: [
                            Text(themeProvider.translate('today'), style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: textPrimary, fontFamily: "LexendExaNormal")),
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: _buildClickableStat(
                                    label: themeProvider.translate('eaten'), value: calorieData.totalEaten, textPrimary: textPrimary, textSecondary: textSecondary,
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            FittedBox(fit: BoxFit.scaleDown, child: Text("${calorieData.leftCalories}", style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: textPrimary, fontFamily: "LexendExaNormal", letterSpacing: -1))),
                                            FittedBox(fit: BoxFit.scaleDown, child: Text(themeProvider.translate('kcal_left'), style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: textSecondary))),
                                          ],
                                        ),
                                      ],
                                    ),
                                ...
                                Expanded(
                                  flex: 3,
                                  child: _buildClickableStat(
                                    label: themeProvider.translate('burned'), value: calorieData.burnedCalories, textPrimary: textPrimary, textSecondary: textSecondary,
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  FittedBox(fit: BoxFit.scaleDown, child: Text(themeProvider.translate('intake_breakdown'), style: TextStyle(fontSize: 13, fontWeight: FontWeight.w900, color: textPrimary, fontFamily: "LexendExaNormal"))),
                                  const SizedBox(height: 25),
                                  SizedBox(height: 140, child: PieChart(PieChartData(sectionsSpace: 0, centerSpaceRadius: 30, startDegreeOffset: 270, sections: _getMacroSections(calorieData)))),
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Center(child: FittedBox(fit: BoxFit.scaleDown, child: Text(themeProvider.translate('summary'), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, color: textPrimary, fontFamily: "LexendExaNormal")))),
                                  const SizedBox(height: 25),
      ...
      floatingActionButton: Padding(
        ...
        child: FloatingActionButton.extended(
          ...
          label: Padding(padding: const EdgeInsets.symmetric(horizontal: 20), child: Text(themeProvider.translate('log_food'), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16, fontFamily: "LexendExaNormal"))),
        ),
      ),
  ...
  Widget _buildClickableStat({required String label, required int value, required Color textPrimary, required Color textSecondary, required VoidCallback onTap}) {
    return Material(
      ...
      child: InkWell(
        ...
        splashColor: themeBlue.withValues(alpha: 0.1), highlightColor: themeBlue.withValues(alpha: 0.05),
        child: Padding(
